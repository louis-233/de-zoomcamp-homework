...
jinja_templates = dict(
    ...
    DL_FILE="fhv_tripdata_{{ execution_date.strftime('%Y-%m') }}.csv",
    OUTPUT_FILE="fhv_tripdata_{{ execution_date.strftime('%Y-%m') }}.parquet",
...
def format_to_parquet(src_file):
    ...
    if not os.path.isfile(src_file):
        print(f"CSV file '{src_file}' does NOT exist")
